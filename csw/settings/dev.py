...
SECRET_KEY = '_x^n75+cx(1!1i_k8!g#$%lk-*3_ys773h_1ti@7wd3)mqz*6m'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/csw.log"),  # 日志文件的位置
...
REST_FRAMEWORK = {
    ...
    # JWT认证机制设置,之后客户端传递的jwt token数据的有效性，如果无效直接返回404错误
